...
class ParfumFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for($i = 0; $i<100 ; $i++)
        {
            ...
            {
                $parfum->setSex('woman');
            }else if($parfum->getBrand() == 'Lancôme'){
                $parfum->setSex('man');
            }
            $parfum->setSex($faker->randomElement($array = array ('man', 'woman')));

            if($parfum->getBrand() == 'Lancôme')
            {
                ...
                $parfum->setName($faker->randomElement($array = array ('Burberry her blosson', 'Burberry her','My Burberry blush','Burberry body', 'Burberry pour femme', 'The beat pour femme')));
            }else if($parfum->getBrand() == 'Bvlgari' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Aqua pour homme', 'Bvlgari man','Bvlgari man in black','Bvlgari man extreme')));
            }else if($parfum->getBrand() == 'Bvlgari' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Omnia', 'Omnia coral','Omnia crystalline','Omnia indian garnet', 'Rose essentielle')));
                ...
                $parfum->setName($faker->randomElement($array = array ('Yes i am pink', 'Loulou','Amor amor l\eau flamingo','Anais Anais premier délice')));
            ...
            }else if($parfum->getBrand() == 'Calvin Klein' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('CK women', 'Women','Obsessed for women','Down town')));
            }else if($parfum->getBrand() == 'Cartier' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Pasha ultimate', 'Carat','La panthère','Must de Cartier', 'Baisé volé')));
            }else if($parfum->getBrand() == 'Cartier' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Carat', 'La panthère','Must de Cartier','Bvlgari man extreme')));
            }else if($parfum->getBrand() == 'Cerruti' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Cerruti 1881 Black', '1881 essentiel','Cerruti image','Cerruti 1881 signature')));
            }else if($parfum->getBrand() == 'Cerruti' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Cerruti 1881 Bella Notte', 'Cerruti 1881pour femme')));
            }else if($parfum->getBrand() == 'Diesel' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Spirit of the brave', 'Only the brave','Fuel for life','Bad')));
            }else if($parfum->getBrand() == 'Diesel' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Fuel for life pour elle', 'Loverdose','Loverdose tattoo')));
            }else if($parfum->getBrand() == 'Dior' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Sauvage', 'Dior homme','Fahrenheit','Eau sauvage')));
            }else if($parfum->getBrand() == 'Dior' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Joy de dior', 'Diorissimo','Miss Dior','J\'adore')));
            }else if($parfum->getBrand() == 'Dolce & Gabbana' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('K by Dolce & Gabbana', 'Light blue sun pour homme','The one grey','The one for men')));
            }else if($parfum->getBrand() == 'Dolce & Gabbana' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('The only one two', 'Dolce rosa excelsa','The one essence','Dolce')));
            }else if($parfum->getBrand() == 'Giorgio Armani' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Armani code', 'Stronger with you','Acqua di gio')));
                ...
                $parfum->setName($faker->randomElement($array = array ('L\'homme idéal cool', 'Habit rouge','L\'instant de Guerlain','Héritage')));
            }else if($parfum->getBrand() == 'Guerlain' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Mon Guerlain', 'La petite robe noire','Insolence','Shalimar')));
            }else if($parfum->getBrand() == 'Gucci' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Gucci pour homme', 'Gucci guilty pour homme')));
                ...
                $parfum->setName($faker->randomElement($array = array ('Terre d\'Hermès', 'Bel ami','Rocabar','Equipage')));
            }else if($parfum->getBrand() == 'Hermès' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Twilly d\Hermès', '24 faubourg','Calèche','Rouge d\'Hermès')));
            }else if($parfum->getBrand() == 'Hugo Boss' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Boss bottled infinite', 'Boss botlled night','Boss the scent','Boss bottled united')));
            }else if($parfum->getBrand() == 'Hugo Boss' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Boss orange', 'Boss nuit pour femme','Hugo woman','Boss femme')));
            }else if($parfum->getBrand() == 'Jean-Paul Gaultier' && $parfum->getSex() == 'man'){
                $parfum->setName($faker->randomElement($array = array ('Le beau', 'Le male in the navy','Le male','Ultra male')));
            }else if($parfum->getBrand() == 'Jean-Paul Gaultier' && $parfum->getSex() == 'woman'){
                $parfum->setName($faker->randomElement($array = array ('Ma dame', 'Classique','La belle','Scandal à Paris')));
            }
